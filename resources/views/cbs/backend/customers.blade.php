                                            ...
                                            <table class="table" id="example1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-20p" style="text-align:left; font-weight: bold;">Profile Photo</th>
                                                        <th class="wd-20p" style="text-align:left; font-weight: bold;">Username</th>
                                                ...
                                                <tbody>
                                                    @foreach ($data as $key => $user)
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center"><img src="{{ asset('/'. $user->profilePicture) }}" width="35" height="35" class="rounded-circle"></td>
